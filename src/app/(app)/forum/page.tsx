...
import { Frown, MessageSquare, Filter } from 'lucide-react';
...
export default function ForumPage() {
  ...
  const loadMore = () => {
    setVisibleQuestions((prev) => prev + QUESTIONS_PER_PAGE);
  };

  const questionsToShow = communityQuestions.slice(0, visibleQuestions);
        ...
        <div className="container mx-auto py-12">
          ...
          <Tabs defaultValue="recent" className="w-full mt-8">
            ...
            <TabsContent value="recent" className="mt-8">
              ...
              {visibleQuestions < communityQuestions.length && (
